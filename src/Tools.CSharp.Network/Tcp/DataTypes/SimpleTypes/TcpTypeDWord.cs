...
{
    public sealed class TcpTypeDWord : ITcpTypeValue<uint>, ITcpEndianness, ITcpTypeConvertible, ITcpCloneable<TcpTypeDWord>
    {
        #region private
        ...
        public TcpTypeDWord()
            : this(true)
        { }
        public TcpTypeDWord(bool bigEndian)
        {
        ...
        //---------------------------------------------------------------------
        public static implicit operator uint(TcpTypeDWord tcpType)
        {
        ...
        public void Write(byte[] dataSource, ref int startPositionInDataSource)
        {
            ...
            //-----------------------------------------------------------------
            Value = _bigEndian ? (uint)IPAddress.NetworkToHostOrder(tmp.Value) : tmp.Value;
            //-----------------------------------------------------------------
        ...
        public TcpTypeDWord Clone()
        {
            return new TcpTypeDWord(_bigEndian) { Value = Value };
        }
        //---------------------------------------------------------------------
